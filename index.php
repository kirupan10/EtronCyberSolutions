    ...
    <section id="about" class="about">
      <div class="container" data-aos="fade-up">
        ...
        <div class="row content">
          <div class="col-lg-6">
            <p>
              Welcome to our cyber security company, 
              where we specialize in providing top-notch security solutions to protect your digital assets.

              Our team consists of experienced and skilled professionals who are passionate about keeping our clients safe from cyber threats. 
              We are committed to providing comprehensive security services that are tailored to meet the unique needs of each client, no matter the size or complexity of their organization.
            </p>
            <ul>
              <li><i class="ri-check-double-line"></i> Network security </li>
              <li><i class="ri-check-double-line"></i> Website security </li>
              <li><i class="ri-check-double-line"></i> Security auditing </li>
              <li><i class="ri-check-double-line"></i> Employee Awareness Training program </li>
              <li><i class="ri-check-double-line"></i> Email social engineering </li>
            </ul>
          </div>
          <div class="col-lg-6 pt-4 pt-lg-0">
            <p>
              At our company, we believe that the key to effective cybersecurity is a proactive approach. That's why we work tirelessly to stay up-to-date with the latest trends and technologies in the field, so that we can anticipate and prevent threats before they become a problem.

We offer a wide range of services, including network security, data protection, vulnerability assessment, penetration testing, and incident response. Our experts use a combination of cutting-edge tools and techniques to identify and address potential vulnerabilities in your systems and infrastructure.
            </p>
        ...
        <div class="row">
          <div class="col-xl-3 col-md-6 d-flex align-items-stretch" data-aos="zoom-in" data-aos-delay="100">
            <div class="icon-box">
              ...
              <p>Network security refers to the protection of computer networks and their components from unauthorized access, theft, damage, or disruption.</p>
            </div>
          </div>
          ...
          <div class="col-xl-3 col-md-6 d-flex align-items-stretch mt-4 mt-md-0" data-aos="zoom-in"
            ...
            <div class="icon-box">
              ...
              <p>Website security refers to the protection of websites and web applications from unauthorized access, theft, damage, or disruption.</p>
            </div>
          </div>
          ...
          <div class="col-xl-3 col-md-6 d-flex align-items-stretch mt-4 mt-xl-0" data-aos="zoom-in"
            ...
            <div class="icon-box">
              ...
              <h4><a href="">security auditing</a></h4>
              <p>Security auditing is the process of evaluating an organization's information security systems, policies, and procedures to identify weaknesses, vulnerabilities, and potential threats.</p>
            </div>
          </div>
          ...
          <div class="col-xl-3 col-md-6 d-flex align-items-stretch mt-4 mt-xl-0" data-aos="zoom-in"
            ...
            <div class="icon-box">
              ...
              <h4><a href="">Employee Awareness Training program</a></h4>
              <p>An Employee Awareness Training program is a comprehensive training program designed to educate employees on the importance of information security,</p>
            </div>
          </div>
      ...
      <div class="container" data-aos="fade-up">
        ...
        <div class="row">
          ...
          <div class="col-lg-7 mt-5 mt-lg-0 d-flex align-items-stretch">
            <form action="config/contact" method="post" role="form" class="php-email-form">
              <div class="row">
              ...
              <div class="text-center"><button type="submit" name ="contact_button">Send Message</button></div>
            </form>
          </div>
